...
{
	out->m[0][0] = F_fabs(out->m[0][0]);
	out->m[0][1] = F_fabs(out->m[0][1]);
	out->m[0][2] = F_fabs(out->m[0][2]);
	out->m[1][0] = F_fabs(out->m[1][0]);
	out->m[1][1] = F_fabs(out->m[1][1]);
	out->m[1][2] = F_fabs(out->m[1][2]);
	out->m[2][0] = F_fabs(out->m[2][0]);
	out->m[2][1] = F_fabs(out->m[2][1]);
	out->m[2][2] = F_fabs(out->m[2][2]);
}
